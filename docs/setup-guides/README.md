...
| Scenario | Command |
|----------|---------|
| I have an API key, want fastest setup | `thala onboard --api-key sk-... --provider openrouter` |
| I want guided prompts | `thala onboard` |
| Config exists, just fix channels | `thala onboard --channels-only` |
| Config exists, I intentionally want full overwrite | `thala onboard --force` |
| Using subscription auth | See [Subscription Auth](../../README.md#subscription-auth-openai-codex--claude-code) |

## Onboarding and Validation

- Quick onboarding: `thala onboard --api-key "sk-..." --provider openrouter`
- Guided onboarding: `thala onboard`
...
- Validate environment: `thala status` + `thala doctor`
