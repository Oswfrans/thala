...
| Hardware | RAM | Thala (base) | Thala (full security) | Status |
|----------|-----|-----------------|--------------------------|--------|
...
**Even with full security, Thala uses <5% of RAM on $10 boards.**

---

## 5. Agnostic Swaps: Everything Remains Pluggable

### Thala's Core Promise: Swap Anything
