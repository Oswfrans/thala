...
## Problem
Thala logs actions but lacks tamper-evident audit trails for:
...
# Tamper evidence
sign_events = true
signing_key_path = "~/.config/thala/audit.key"
...
thala audit --user @alice

# Show all high-risk commands
thala audit --risk high

# Show violations from last 24 hours
thala audit --since 24h --violations-only

# Export to JSON for analysis
thala audit --format json --output audit.json
