...
- CLI `thala sop` currently manages definitions only: `list`, `validate`, `show`.
...
2. Create a SOP directory, for example:
   ...
   ```text
   ~/.thala/workspace/sops/deploy-prod/SOP.toml
   ~/.thala/workspace/sops/deploy-prod/SOP.md
   ```
