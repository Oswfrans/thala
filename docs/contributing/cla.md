# Thala Contributor License Agreement (CLA)
...
property rights granted by contributors to Thala Labs. This agreement
protects both contributors and users of the Thala project.

By submitting a contribution (pull request, patch, issue with code, or any
other form of code submission) to the Thala repository, you agree to the
terms of this CLA.
...
- **"Contribution"** means any original work of authorship, including any
  modifications or additions to existing work, submitted to Thala Labs
  for inclusion in the Thala project.

- **"You"** means the individual or legal entity submitting a Contribution.

- **"Thala Labs"** means the maintainers and organization responsible
  for the Thala project at https://github.com/oswfrans/thala.

---

## 2. Grant of Copyright License

You grant Thala Labs and recipients of software distributed by Thala
...
Thala that covers your Contribution, your patent license to the project
is not revoked.
...
This CLA does **not** transfer ownership of your Contribution to Thala
...
3. If your employer has rights to intellectual property you create, you
   ...
   has signed a corporate CLA with Thala Labs.

---

## 6. No Trademark Rights

This CLA does not grant you any rights to use the Thala name,
trademarks, service marks, or logos. See [trademark policy](../maintainers/trademark.md) for details.

---

## 7. Attribution

Thala Labs will maintain attribution to contributors in the repository
...
All Contributions accepted into the Thala project are licensed under
both:
...
By opening a pull request or submitting a patch to the Thala repository,
...
https://github.com/oswfrans/thala/issues

---

*This CLA is based on the Apache Individual Contributor License Agreement
v2.0, adapted for the Thala dual-license model.*
