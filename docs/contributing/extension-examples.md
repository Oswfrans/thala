...
Thala's architecture is trait-driven and modular.
...
```rust
// In your crate: use thala::tools::traits::{Tool, ToolResult};
...
Channels let Thala communicate through any messaging platform.
...
```rust
// In your crate: use thala::channels::traits::{Channel, ChannelMessage, SendMessage};
...
Providers are LLM backend adapters. Each provider connects Thala to a different model API.
...
```rust
// In your crate: use thala::providers::traits::Provider;
...
```rust
// In your crate: use thala::memory::traits::{Memory, MemoryEntry, MemoryCategory};
