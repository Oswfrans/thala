...
Rules for pull request quality, attribution, privacy, and handoff in Thala.
...
- If identity-like context is unavoidable, use Thala-scoped roles/labels only (e.g., `ThalaAgent`, `ThalaOperator`, `thala_user`).
- Recommended identity-safe naming palette:
    - actor labels: `ThalaAgent`, `ThalaOperator`, `ThalaMaintainer`, `thala_user`
    - service/runtime labels: `thala_bot`, `thala_service`, `thala_runtime`, `thala_node`
    - environment labels: `thala_project`, `thala_workspace`, `thala_channel`
