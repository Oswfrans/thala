# Thala Docs Summary (Unified TOC)

This file is the canonical table of contents for the documentation currently present in this repository.
...
- [setup-guides/one-click-bootstrap.vi.md](setup-guides/one-click-bootstrap.vi.md)
...
- [reference/cli/commands-reference.vi.md](reference/cli/commands-reference.vi.md)
- [reference/api/config-reference.md](reference/api/config-reference.md)
- [reference/api/config-reference.vi.md](reference/api/config-reference.vi.md)
...
- [reference/sop/README.md](reference/sop/README.md)
- [reference/sop/connectivity.md](reference/sop/connectivity.md)
- [reference/sop/cookbook.md](reference/sop/cookbook.md)
- [reference/sop/observability.md](reference/sop/observability.md)
- [reference/sop/syntax.md](reference/sop/syntax.md)
